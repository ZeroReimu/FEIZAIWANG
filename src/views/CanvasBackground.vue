...
export default {
  ...
  data() {
    return {
      PhotoMsg: {
        //TopImg:"https://cdn.acgproject.cn/banner-48.png",
        TopNavImg: "https://cdn.acgproject.cn/banner-9.png"
        //Logo:"https://cdn.acgproject.cn/logo-48.png",
      }
    };
  },
  ...
  methods: {
    ...
    yiyan:function(){
      //axios.get('http://v1.hitokoto.cn/?c=a&c=b&c=c')//一言地址 a:动画 b:漫画 c:游戏
      axios.get('http://v1.hitokoto.cn/?c=h&c=i&c=k')//h:影视 i:诗词 k:哲学
        .then(({ data }) => {
          const hitokoto = document.getElementById('hitokoto_text')
          const hitokoto_from = document.getElementById('hitokoto_from')
          //hitokoto.href = 'http://hitokoto.cn/?uuid=' + data.uuid //返回一言信息
